...
module.exports = async (req, res) => {
  ...
  const system = [
    ...
    "أجب بالعربية فقط وبأسلوب احترافي واضح.",
    "التزم بالبيانات المرفقة فقط، ولا تعتمد على معرفة خارجية.",
    'إذا كانت البيانات غير كافية، اكتب: "لا تتوفر بيانات كافية للإجابة".',
    "اجعل الرد على قدر السؤال:",
    "- إذا كان السؤال مباشرًا ويطلب رقمًا واحدًا: سطران فقط (النتيجة + تفسير مختصر).",
    "- إذا كان السؤال تحليليًا: استخدم عند الحاجة الأقسام التالية: ملخص، الأرقام، التحليل، ملاحظات.",
    "لا تكرر نفس الرقم في أكثر من موضع إلا إذا كان ذلك ضروريًا للفهم.",
  ].join("\n");
